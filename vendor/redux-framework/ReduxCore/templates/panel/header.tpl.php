...
?>
<div id="redux-header" style="background-color: #fff;border-color: #05d1a3;padding: 20px;">
    <?php if ( ! empty( $this->parent->args['display_name'] ) ) { ?>
        <div class="display_header" style="float:none;">
            <div class="logo-display" style="position: absolute; left: 20px; top: 0; display: flex; align-items: center; justify-content: center; height: 100%; ">
                <img src="<?php echo plugin_dir_url(__FILE__).'assets/logo.png' ?>" alt="logo" style ="width: 200px;">
            </div>
        ...
        <h2 style="color:#333;"><?php echo wp_kses_post( $this->parent->args['display_name'] ); ?></h2>
    <?php } ?>
