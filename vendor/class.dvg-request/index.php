...
class DVG_REQUEST {
     ...
     *
     * @see DVG_REQUEST::get_certificate_path()
     * @see DVG_REQUEST::set_certificate_path()
     *
     * @var string
     */
     ...
     *    {@see DVG_REQUEST::request}
     *    (string, required)
     * - `headers`: Associative array of header fields. Same as the `$headers`
     *    parameter to {@see DVG_REQUEST::request}
     *    (array, default: `array()`)
     * - `data`: Associative array of data fields or a string. Same as the
     *    `$data` parameter to {@see DVG_REQUEST::request}
     *    (array|string, default: `array()`)
     * - `type`: HTTP request type (use Requests constants). Same as the `$type`
     *    parameter to {@see DVG_REQUEST::request}
     *    (string, default: `DVG_REQUEST::GET`)
     * - `cookies`: Associative array of cookie name to value, or cookie jar.
     *    (array|Requests_Cookie_Jar)
     *
     * If the `$options` parameter is specified, individual requests will
     * inherit options from it. This can be used to use a single hooking system,
     * or set all the types to `DVG_REQUEST::POST`, for example.
     *
     ...
     * @param array $options Global and default options (see {@see DVG_REQUEST::request})
     ...
     *
     * @see DVG_REQUEST::request() for values returned by this method
    ...
    protected static function get_default_options($multirequest = false) {
        $defaults = array(
            ...
            'hooks' => null,
            'transport' => null,
            'verify' => DVG_REQUEST::get_certificate_path(),
            'verifyname' => true,
        );
    ...
    public static function get_certificate_path() {
        if ( ! empty( DVG_REQUEST::$certificate_path ) ) {
            return DVG_REQUEST::$certificate_path;
        }
    ...
    public static function set_certificate_path( $path ) {
        DVG_REQUEST::$certificate_path = $path;
    }
     ...
     * @param array $request Request data as passed into {@see DVG_REQUEST::request_multiple()}
     ...
     *
     * @codeCoverageIgnore
     * @deprecated Misspelling of {@see DVG_REQUEST::flatten}
     * @param array $array Dictionary of header values
     * @return array List of headers
     */
