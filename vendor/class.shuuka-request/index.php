...
class SHUUKA_REQUEST {
     ...
     *
     * @see SHUUKA_REQUEST::get_certificate_path()
     * @see SHUUKA_REQUEST::set_certificate_path()
     *
     * @var string
     */
     ...
     *    {@see SHUUKA_REQUEST::request}
     *    (string, required)
     * - `headers`: Associative array of header fields. Same as the `$headers`
     *    parameter to {@see SHUUKA_REQUEST::request}
     *    (array, default: `array()`)
     * - `data`: Associative array of data fields or a string. Same as the
     *    `$data` parameter to {@see SHUUKA_REQUEST::request}
     *    (array|string, default: `array()`)
     * - `type`: HTTP request type (use Requests constants). Same as the `$type`
     *    parameter to {@see SHUUKA_REQUEST::request}
     *    (string, default: `SHUUKA_REQUEST::GET`)
     * - `cookies`: Associative array of cookie name to value, or cookie jar.
     *    (array|Requests_Cookie_Jar)
     *
     * If the `$options` parameter is specified, individual requests will
     * inherit options from it. This can be used to use a single hooking system,
     * or set all the types to `SHUUKA_REQUEST::POST`, for example.
     *
     ...
     * @param array $options Global and default options (see {@see SHUUKA_REQUEST::request})
     ...
     *
     * @see SHUUKA_REQUEST::request() for values returned by this method
    ...
    protected static function get_default_options($multirequest = false) {
        $defaults = array(
            ...
            'hooks' => null,
            'transport' => null,
            'verify' => SHUUKA_REQUEST::get_certificate_path(),
            'verifyname' => true,
        );
    ...
    public static function get_certificate_path() {
        if ( ! empty( SHUUKA_REQUEST::$certificate_path ) ) {
            return SHUUKA_REQUEST::$certificate_path;
        }
    ...
    public static function set_certificate_path( $path ) {
        SHUUKA_REQUEST::$certificate_path = $path;
    }
     ...
     * @param array $request Request data as passed into {@see SHUUKA_REQUEST::request_multiple()}
     ...
     *
     * @codeCoverageIgnore
     * @deprecated Misspelling of {@see SHUUKA_REQUEST::flatten}
     * @param array $array Dictionary of header values
     * @return array List of headers
     */
